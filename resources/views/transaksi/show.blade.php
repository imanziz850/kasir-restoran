 ...
 'icon'=>'fas fa-cash-register'
    ...
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('transaksi.status',['transaksi'=>$transaksi->id,'status'=>'cancel']) }}" class="btn btn-danger float-right">Batalkan Transaksi</a>
            @else
            <a href="{{ route('transaksi.status',['transaksi'=>$transaksi->id,'status'=>'success']) }}" class="btn btn-success float-right">Accept Transaksi</a>
            @endif
        </div>
    </div>
</x-content>
